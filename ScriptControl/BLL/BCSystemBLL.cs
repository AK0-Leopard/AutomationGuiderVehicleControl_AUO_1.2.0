...
namespace com.mirle.ibg3k0.sc.BLL
{
    ...
    public class BCSystemBLL
    {
        ...
        /// The bc status DAO
        /// </summary>
        protected BCStatusDao bcStatusDao = null;
        /// <summary>
        /// The operation his DAO
        /// </summary>
        protected OperationHisDao operationHisDao = null;
        ...
        public virtual void start(SCApplication scApp)
        {
            this.scApp = scApp;
        ...
        public virtual SCAppConstants.BCSystemInitialRtnCode initialBCSystem()
        {
        ...
        /// </summary>
        public virtual void reWriteBCSystemRunTime()
        {
            string bc_id = scApp.getBCFApplication().BC_ID;
            try
            {
        ...
        public virtual Boolean closeBCSystem()
        {
            string bc_id = scApp.getBCFApplication().BC_ID;
            try
            {
        ...
        public virtual void updateSystemParameter(string ecid, string val, Boolean refreshSecsAgent)
        {
            try
            {
        ...
        public virtual void addOperationHis(string user_id, string formName, string action)
        {
