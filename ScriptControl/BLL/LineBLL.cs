...
namespace com.mirle.ibg3k0.sc.BLL
{
    public class LineBLL
    {
        ...
        protected ZoneDao zoneDao = null;
        protected NodeDao nodeDao = null;
        protected EqptDao eqptDao = null;
        protected UnitDao unitDao = null;
        protected PortDao portDao = null;
        protected BufferPortDao bufferPortDao = null;
        protected ECDataMapDao ecDataMapDao = null;
        ...
        public virtual List<AECDATAMAP> loadAllECDataList()
        {
            DBConnection_EF conn = null;
            List<AECDATAMAP> rtnList = new List<AECDATAMAP>();
            try
            {
                conn = DBConnection_EF.GetContext();
                conn.BeginTransaction();
                rtnList = ecDataMapDao.loadAllECDataMaps(conn);
                conn.Commit();
            }
            catch (Exception ex)
            {
