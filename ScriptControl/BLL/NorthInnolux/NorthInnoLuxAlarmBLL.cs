...
namespace com.mirle.ibg3k0.sc.BLL
{
    ...
    /// Class AlarmBLL.
    /// </summary>
    public class NorthInnoLuxAlarmBLL: AlarmBLL
    {
        ...
        public override bool hasAlarmExistByEQ(string eqid)
        {
        ...
        public override List<ALARMRPTCOND> loadAllAlarmReport()
        {
        ...
        public override List<ALARMRPTCOND> loadAllAlarmReport(bool is_enable)
        {
            List<ALARMRPTCOND> aLARMRPTCONDs = null;
            try
            {
        ...
        public override bool enableAllAlarmReport(Boolean isEnable)
        {
            bool isSuccess = true;
            try
            {
