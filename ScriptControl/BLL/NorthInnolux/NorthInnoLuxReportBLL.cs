...
namespace com.mirle.ibg3k0.sc.BLL
{
    ...
    /// Class ReportBLL.
    /// </summary>
    public class NorthInnoLuxReportBLL:ReportBLL
    {
        /// <summary>
        /// The sc application
        /// </summary>
        ...
        public override bool newReportLoadFailed(string vhID,List<AMCSREPORTQUEUE> reportqueues)
        {
            bool isSuccsess = true;
        ...
        public override bool newReportUnloadFailed(string vhID, List<AMCSREPORTQUEUE> reportqueues)
        {
            bool isSuccsess = true;
        ...
        public override bool ReportAlarmCleared()
        {
            bool isSuccsess = true;
        ...
        {
            bool isSuccsess = true;
            isSuccsess = isSuccsess && (iBSEMDriver as NorthInnoluxMCSDefaultMapAction).S6F11SendAlarmEvent(eq_id, ceid, alid, cmd_id, altx, alarmLvl, reportQueues);
            return isSuccsess;
        }
