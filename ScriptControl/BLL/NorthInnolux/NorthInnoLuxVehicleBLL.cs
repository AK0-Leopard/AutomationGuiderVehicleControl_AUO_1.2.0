...
{
    public class NorthInnoLuxVehicleBLL: VehicleBLL
    {
                private static Logger logger = LogManager.GetCurrentClassLogger();


        public NorthInnoLuxVehicleBLL()
        {
        ...
        public override bool doTransferCommandFinish(string vh_id, string cmd_id, CompleteStatus completeStatus, int total_cmd_dis)
        {
            ...
            try
            {
                ...
                vh.VehicleUnassign();
                vh.Stop();
                scApp.VehicleService.ProcessAlarmReport(vh, AlarmBLL.VEHICLE_LONG_TIME_INACTION, ErrorStatus.ErrReset, $"vehicle long time inaction, cmd id:{cmd_id}");
                ...
                isSuccess &= scApp.CMDBLL.updateCommand_OHTC_CompleteStatusByCmdID(vh_id, cmd_id, ohtc_cmd_status, completeStatus);
                ...
                if (!SCUtility.isEmpty(mcs_cmd_id))
                {
                    ...
                    if ((completeStatus == CompleteStatus.CmpStatusVehicleAbort) && vh.NeedToRetryAfterVehicleAbort) //20201030 added
                    {
                        //do nothing...
                    }
                    else
