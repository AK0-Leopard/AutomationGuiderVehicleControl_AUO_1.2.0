...
// ------------- -------------  -------------  ------  -----------------------------
// 2020/03/24    Kevin Wei      N/A            A0.01   當Vehicle結束命令(Cancel、Abort)時，
...
namespace com.mirle.ibg3k0.sc.Data.SECS.AGVC
{
    /// <summary>
    /// Class SECSConst.
    /// </summary>
    public class SECSConst
    {
        ...
        public const string CMD_Result_FromOperator = "66";
        public const string CMD_Result_LocalError = "67";
