...
namespace com.mirle.ibg3k0.sc
{
    public partial class ASECTION
    {
        ...
        public string Vhs
        {
            get { return string.Join(",", CurrentVhs.Keys.ToArray()); }
        }
        public string ForwardVhs
        {
            get { return string.Join(",", DriveDirForwardVhs.Keys.ToArray()); }
        }
        public string ReverseVhs
        {
            get { return string.Join(",", DriveDirReverseVhs.Keys.ToArray()); }
        }
