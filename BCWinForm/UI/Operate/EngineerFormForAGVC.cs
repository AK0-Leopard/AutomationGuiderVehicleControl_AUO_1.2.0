...
#pragma warning restore CS0067 // 事件 'EngineerFormForAGVC.evtSectionSelected' 從未使用過
        ...
        private void btn_search_for_fromto_Click(object sender, EventArgs e)
        {
            ...
            int total_cost = 0;
            (isSuccess, guide_start_to_from_segment_ids, guide_start_to_from_section_ids, guide_start_to_from_address_ids, total_cost) = mainForm.BCApp.SCApplication.GuideBLL.getGuideInfoIgnoreCost(from_adr, to_adr);
