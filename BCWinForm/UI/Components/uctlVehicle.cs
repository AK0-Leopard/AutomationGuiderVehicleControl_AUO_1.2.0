...
namespace com.mirle.ibg3k0.bc.winform.UI.Components
{
    public partial class uctlVehicle : UserControl
    {
        ...
        private int m_iLocX;
        private int m_iLocY;
#pragma warning disable CS0414 // 已指派欄位 'uctlVehicle.m_iMemStatus'，但從未使用過其值。
        private int m_iMemStatus = 0;
#pragma warning restore CS0414 // 已指派欄位 'uctlVehicle.m_iMemStatus'，但從未使用過其值。
#pragma warning disable CS0414 // 已指派欄位 'uctlVehicle.m_bMemPresence'，但從未使用過其值。
        private bool m_bMemPresence = false;
#pragma warning restore CS0414 // 已指派欄位 'uctlVehicle.m_bMemPresence'，但從未使用過其值。
                    ...
                    if (groupRails != null)
                    {
                        switch (eqpt.VhRecentTranEvent)
                        {
                            ...
                            case EventType.AdrOrMoveArrivals:
                                ...
                                Uctl_Map.stopFlashingSpecifyRail(eqpt.PredictSections);
                                break;
                        }
                    }
                }
